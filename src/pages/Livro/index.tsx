                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.rodape}>
                        <View style={{ flexDirection: 'row', justifyContent: 'center'}}>
                            <Button onPress={() => addFavorite(dadosLivro)}><Ionicons name='heart-circle' color='#2a8ba1' size={50} /></Button>
                            <Button onPress={() => addCart(dadosLivro?.codigoLivro)}><Ionicons name='cart' color='#2a8ba1' size={50} /></Button>
                        </View>
                    </View>
                </View>
            </ImageBackground>
